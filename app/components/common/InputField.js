...
function InputField({ backgroundColor = Colors.white, autoFocus = false, elevation = 0, borderColor = Colors.primary, rightIcon = false, rightFunction, borderWidth = 0, placeHolder, value, onChange, width = "100%", height = RFPercentage(6), icon, secure = false, iconType = "MaterialCommunityIcons", editable = true, startEdit, endEdit }) {
    const [eyeIcon, setEyeIcon] = useState(false)

    return (
        <View style={{
            backgroundColor, borderRadius: RFPercentage(1),
            ...
            <View style={{ width: "100%", flexDirection: "row", alignItems: "center" }} >
                ...
                <TextInput style={{ color: Colors.black, padding: rightIcon ? 0 : RFPercentage(1), width: icon ? "95%" : "100%", fontSize: RFPercentage(2.4) }}
